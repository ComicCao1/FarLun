...
#define BOMBCAP_FLASH_RADIUS (GLOB.max_explosion_range*1.5)
									// NTNet module-configuration values. Do not change these. If I need to add another use larger number (5..6..7 etc)
...
// clamed rand()
// example: CLAMPED_RAND(10, 1) can return 9, 10, or 11
#define CLAMPED_RAND(X, Y)	rand(X - Y, X + Y)
