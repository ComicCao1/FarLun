...
/obj/machinery/vending
	...
	*/
	...
	var/vend_reply //Thank I for shopping!
	var/last_reply = 0
...
/obj/machinery/vending/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	if (currently_vending && vendor_account && !vendor_account.suspended)
		...
		if(paid)
			...
			return // don't smack that machine with my 2 thalers
	...
	if (I || istype(W, /obj/item/weapon/spacecash))
		...
		to_chat(user, "I [src.panel_open ? "open" : "close"] the maintenance panel.")
		src.overlays.Cut()
		if(src.panel_open)
		...
		if(ishuman(user)) // strength check
			var/mob/living/carbon/human/H = user
			if(!H.check_st(11))
				to_chat(H, "<span class='notice'>I'm not strong enough for this!</span>")
				return

		user.visible_message("<span class='notice'>\The [user] tries to force the front panel open on the [src]!</span>",
							"<span class='notice'>I try to force the front panel open on the [src]!</span>")
		if(do_after(user,50,src))
			user.visible_message("<span class='notice'>\The [user] forces the front panel open on the [src], and all the contents fall out in all different directions!</span>",
								"<span class='notice'>I force the front panel open on the [src], and all the contents fall out in all different directions!</span>")
			for(var/datum/stored_items/vending_products/product in product_records)
				var/turf/dispenseTarget = get_random_turf_in_range(src,1,1)
				while(dispenseTarget.density)				dispenseTarget = get_random_turf_in_range(src,1,1)  // make sure player can grab the items
				while(product.get_product(dispenseTarget))	continue  // keep dispensing until we run out
		return
...
/obj/machinery/vending/Topic(href, href_list)
	...
	if(href_list["remove_coin"] && !istype(usr,/mob/living/silicon))
		...
		to_chat(usr, "<span class='notice'>I remove \the [coin] from \the [src]</span>")
		coin = null
		categories &= ~CAT_COIN
...
/obj/machinery/vending/proc/vend(var/datum/stored_items/vending_products/R, mob/user)
	...
	if (R.category & CAT_COIN)
		...
		if(coin.string_attached)
			if(prob(50))
				to_chat(user, "<span class='notice'>I successfully pull the coin out before \the [src] could swallow it.</span>")
			else
				to_chat(user, "<span class='notice'>I weren't able to pull the coin out fast enough, the machine ate it, string and all.</span>")
				qdel(coin)
				coin = null
				categories &= ~CAT_COIN
		else
...
/obj/machinery/vending/proc/stock(obj/item/weapon/W, var/datum/stored_items/vending_products/R, var/mob/user)
	...
	if(R.add_product(W))
		to_chat(user, "<span class='notice'>I insert \the [W] in the product receptor.</span>")
		SSnano.update_uis(src)
		return 1
...
/obj/machinery/vending/boozeomat
	...
	product_slogans = "I hope nobody asks me for a bloody cup o' tea...;Alcohol is humanity's friend. Would I abandon a friend?;Quite delighted to serve me!;Is nobody thirsty on this station?"
	product_ads = "Drink up!;Booze is good for me!;Alcohol is humanity's best friend.;Quite delighted to serve me!;Care for a nice, cold beer?;Nothing cures I like booze!;Have a sip!;Have a drink!;Have a beer!;Beer is good for me!;Only the finest alcohol!;Best quality booze since 2053!;Award-winning wine!;Maximum alcohol!;Man loves beer.;A toast for progress!"
...
/obj/machinery/vending/coffee
	...
	product_ads = "Have a drink!;Drink up!;It's good for me!;Would I like a hot joe?;I'd kill for some coffee!;The best beans in the galaxy.;Only the finest brew for you.;Mmmm. Nothing like a coffee.;I like coffee, don't you?;Coffee helps me  work!;Try some tea.;We hope I like the best!;Try our new chocolate!;Admin conspiracies"
	icon_state = "coffee"
...
/obj/machinery/vending/snack
	...
	product_ads = "The healthiest!;Award-winning chocolate bars!;Mmm! So good!;Oh my god it's so juicy!;Have a snack.;Snacks are good for me!;Have some more Getmore!;Best quality snacks straight from mars.;We love chocolate!;Try our new jerky!"
	icon_state = "snack"
...
/obj/machinery/vending/fitness
	name = "SweatMAX"
	desc = "An exercise aid and nutrition supplement vendor that preys on my inadequacy."
	product_slogans = "SweatMAX, get robust!"
	product_ads = "Pain is just weakness leaving the body!;Run! My fat is catching up to me;Never forget leg day!;Push out!;This is the only break I get today.;Don't cry, sweat!;Healthy is an outfit that looks good on everybody."
	icon_state = "fitness"
...
/obj/machinery/vending/cigarette
	...
	desc = "A specialized vending machine designed to contribute to my slow and uncomfortable death."
	product_slogans = "There's no better time to start smokin'.;\
		Smoke now, and win the adoration of my peers.;\
		They beat cancer centuries ago, so smoke away.;\
		If you're not smoking, I must be joking."
	product_ads = "Probably not bad for me!;\
		...
		Don't be so hard on myself, kid. Smoke a Lucky Star!;\
...
/obj/machinery/vending/medical
	...
	icon_vend = "med-vend"
	vend_delay = 18
	product_ads = "Go save some lives!;The best stuff for my medbay.;Only the finest tools.;Natural chemicals!;This stuff saves lives.;Don't I want some?;Ping!"
...
/obj/machinery/vending/phoronresearch
	name = "Toximate 3000"
	desc = "All the fine parts I need in one vending machine!"
...
/obj/machinery/vending/wallmed1
	...
	product_ads = "Go save some lives!;The best stuff for my medbay.;Only the finest tools.;Natural chemicals!;This stuff saves lives.;Don't I want some?"
	icon_state = "wallmed"
...
/obj/machinery/vending/security
	...
	product_ads = "Crack capitalist skulls!;Beat some heads in!;Don't forget - harm is good!;My weapons are right here.;Handcuffs!;Freeze, scumbag!;Don't tase me bro!;Tase them, bro.;Why not have a donut?"
	icon_state = "sec"
	icon_deny = "sec-deny"
	icon_vend = "sec-vend"
	vend_delay = 14
	req_access = list(access_security)
	products = list(/obj/item/weapon/handcuffs = 10,/obj/item/weapon/grenade/flashbang = 4,/obj/item/weapon/grenade/chem_grenade/teargas = 4,/obj/item/device/flash = 5,
					/obj/item/weapon/reagent_containers/food/snacks/donut/normal = 12,/obj/item/weapon/storage/box/evidence = 6, /obj/item/weapon/gun/projectile/beretta = 6, /obj/item/ammo_magazine/mc9mmds = 12,
					/obj/item/weapon/gun/energy/taser = 12)
	contraband = list(/obj/item/clothing/glasses/sunglasses = 2,/obj/item/weapon/storage/box/donut = 2,)

/obj/machinery/vending/hydronutrients
	name = "NutriMax"
	desc = "A plant nutrients vendor."
	product_slogans = "Aren't I glad I don't have to fertilize the natural way?;Now with 50% less stink!;Plants are people too!"
	product_ads = "We like plants!;Don't I want some?;The greenest thumbs ever.;We like big plants.;Soft soil..."
	icon_state = "nutri"
...
/obj/machinery/vending/hydroseeds
	...
	desc = "When I need seeds fast!"
	product_slogans = "THIS'S WHERE TH' SEEDS LIVE! GIT I SOME!;Hands down the best seed selection this half of the galaxy!;Also certain mushroom varieties available, more for experts! Get certified today!"
...
/obj/machinery/vending/dinnerware
	...
	product_ads = "Mm, food stuffs!;Food and food accessories.;Get my plates!;I like forks?;I like forks.;Woo, utensils.;I don't really need these..."
...
/obj/machinery/vending/sovietsoda
	...
	product_ads = "For Tsar and Country.;Have I fulfilled my nutrition quota today?;Very nice!;We are simple people, for this is all we eat.;If there is a person, there is a problem. If there is no person, then there is no problem."
...
/obj/machinery/vending/engivend
	name = "Engi-Vend"
	desc = "Spare tool vending. What? Did I expect some witty description?"
	icon_state = "engivend"
...
/obj/machinery/vending/engineering
	...
	desc = "Everything I need for do-it-myself repair."
	icon_state = "engi"
	icon_deny = "engi-deny"
	req_one_access = list(access_atmospherics,access_engine_equip)
...
/obj/machinery/vending/robotics
	...
	desc = "All the tools I need to create my own robot army."
	icon_state = "robotics"
...
/obj/machinery/vending/fashionvend
	...
	desc = "For all my cheap knockoff needs."
	product_slogans = "Look smashing for my darling!;Be rich! Dress rich!"
	icon_state = "theater"
	vend_delay = 15
	vend_reply = "Absolutely smashing!"
	product_ads = "Impress the love of my life!;Don't look poor, look rich!;100% authentic designers!;All sales are final!;Lowest prices guaranteed!"
...
/obj/machinery/vending/games
	name = "Good Clean Fun"
	desc = "Vends things that the CO and SEA are probably not going to appreciate I fiddling with instead of my job..."
	vend_delay = 15
	product_slogans = "Escape to a fantasy world!;Fuel my gambling addiction!;Ruin my friendships!"
...
/obj/machinery/vending/lavatory
	...
	desc = "Vends things that make I less reviled in the work-place!"
	vend_delay = 15
	product_slogans = "Take a shower I hippie.;Get a haircut, hippie!;Reeking of vox taint? Take a shower!"
...
/obj/machinery/vending/hotfood
	name = "Hot Foods"
	desc = "An old vending machine promising 'hot foods'. I doubt any of its contents are still edible."
	vend_delay = 40
